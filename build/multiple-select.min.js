...
scope.onSuggestedItemsClick(filteredSuggestionArr[scope.selectedItemIndex]);}};scope.onSuggestedItemsClick=function(selectedValue){if(scope.isSingleChoose){scope.modelArr=selectedValue;scope.isHover=false;scope.isFocused=false;console.log(scope.modelArr);}else{scope.modelArr.push(selectedValue);}
